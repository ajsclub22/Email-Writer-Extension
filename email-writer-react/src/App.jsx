...
import Container from '@mui/material/Container'; // for MUI Container
import Typography from '@mui/material/Typography'; // for MUI Typography
import './App.css'
    ...
    <Container maxWidth="md" sx={{py:4}}>
      <Typography variant='h3' component="h1" gutterBottom>
        ...
        <Box sx = {{mx:3}}>
          ...
          variant='outlined' label="Original Email Content"
          value={emailContent || ''}
